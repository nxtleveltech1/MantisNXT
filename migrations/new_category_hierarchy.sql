...
-- Step 1: Set all product category references to NULL
UPDATE core.product SET category_id = NULL WHERE category_id IS NOT NULL;
UPDATE core.supplier_product SET category_id = NULL WHERE category_id IS NOT NULL;
...
-- 1 Guitars, Basses & Amps (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Guitars, Basses & Amps', NULL, 1, '/guitars-basses-amps', true, NOW(), NOW());

-- 2 Drums & Percussion (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Drums & Percussion', NULL, 1, '/drums-percussion', true, NOW(), NOW());

-- 3 Keyboards, Pianos & Synths (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Keyboards, Pianos & Synths', NULL, 1, '/keyboards-pianos-synths', true, NOW(), NOW());

-- 4 Orchestral, Band & Folk (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Orchestral, Band & Folk', NULL, 1, '/orchestral-band-folk', true, NOW(), NOW());

-- 5 Studio, Recording & Production (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Studio, Recording & Production', NULL, 1, '/studio-recording-production', true, NOW(), NOW());

-- 6 Microphones & Wireless (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Microphones & Wireless', NULL, 1, '/microphones-wireless', true, NOW(), NOW());

-- 7 Live Sound & PA (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Live Sound & PA', NULL, 1, '/live-sound-pa', true, NOW(), NOW());

-- 8 DJ & Electronic Music (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'DJ & Electronic Music', NULL, 1, '/dj-electronic-music', true, NOW(), NOW());

-- 9 Lighting, Stage & Effects (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Lighting, Stage & Effects', NULL, 1, '/lighting-stage-effects', true, NOW(), NOW());

-- 10 Software & Plugins (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Software & Plugins', NULL, 1, '/software-plugins', true, NOW(), NOW());

-- 11 Installed AV, Conferencing & Video (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Installed AV, Conferencing & Video', NULL, 1, '/installed-av-conferencing-video', true, NOW(), NOW());

-- 12 Consumer Audio, Hi-Fi & Portable (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Consumer Audio, Hi-Fi & Portable', NULL, 1, '/consumer-audio-hi-fi-portable', true, NOW(), NOW());

-- 13 Cables, Connectors & Power (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Cables, Connectors & Power', NULL, 1, '/cables-connectors-power', true, NOW(), NOW());

-- 14 Accessories, Cases, Racks & Stands (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Accessories, Cases, Racks & Stands', NULL, 1, '/accessories-cases-racks-stands', true, NOW(), NOW());

-- 15 Spares, Components & Consumables (Level 1)
INSERT INTO core.category (category_id, name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (gen_random_uuid(), 'Spares, Components & Consumables', NULL, 1, '/spares-components-consumables', true, NOW(), NOW());
