...
('b2c3d4e5-f6g7-8901-bcde-f21234567890', 'StartupHub LLC', 'startuphub', 'professional', '{"features": ["supply_chain", "customer_ops"], "limits": {"users": 50, "storage_gb": 100}}');

-- =======================
-- SEED USER PROFILES
-- =======================

-- Note: In real deployment, these would be created after Supabase Auth users exist
...
('22222222-2222-2222-2222-222222222222', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'ops_manager', 'Bob Chen', 'https://ui-avatars.com/api/?name=Bob+Chen', '{"timezone": "America/Los_Angeles", "notifications": {"email": true, "push": false}}'),
('33333333-3333-3333-3333-333333333333', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'ai_team', 'Carol Martinez', 'https://ui-avatars.com/api/?name=Carol+Martinez', '{"timezone": "America/Chicago", "theme": "dark"}'),
('44444444-4444-4444-4444-444444444444', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'cs_agent', 'David Kim', 'https://ui-avatars.com/api/?name=David+Kim', '{"timezone": "America/New_York", "language": "en"}'),

-- StartupHub users
('55555555-5555-5555-5555-555555555555', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'admin', 'Emma Wilson', 'https://ui-avatars.com/api/?name=Emma+Wilson', '{"timezone": "Europe/London", "notifications": {"email": true, "push": true}}'),
('66666666-6666-6666-6666-666666666666', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'ops_manager', 'Frank Rodriguez', 'https://ui-avatars.com/api/?name=Frank+Rodriguez', '{"timezone": "America/Denver", "theme": "light"}'),
('77777777-7777-7777-7777-777777777777', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'cs_agent', 'Grace Lee', 'https://ui-avatars.com/api/?name=Grace+Lee', '{"timezone": "Asia/Seoul", "language": "ko"}');
...
('bbbb1111-cccc-2222-dddd-333344445555', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'Local Office Supplies', 'orders@localoffice.com', '+1-555-0201', '{"street": "321 Main St", "city": "Denver", "state": "CO", "zip": "80202", "country": "USA"}', 30, 'active', 'Net 30', 5, '{}'),
('bbbb2222-cccc-3333-dddd-444455556666', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'Tech Solutions Inc', 'support@techsolutions.com', '+1-555-0202', '{"street": "654 Innovation Ave", "city": "Seattle", "state": "WA", "zip": "98101", "country": "USA"}', 20, 'active', 'Net 45', 10, '{"ISO-27001"}');
...
('inv55555-5555-5555-5555-555555555555', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'OFF-001', 'A4 Copy Paper (500 sheets)', 'White multipurpose copy paper', 'consumables', 8.99, 150, 50, 500, 'bbbb1111-cccc-2222-dddd-333344445555', 'Office-Storage'),
('inv66666-6666-6666-6666-666666666666', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'OFF-002', 'Blue Ballpoint Pens (Pack of 12)', 'Medium point blue ink pens', 'consumables', 12.99, 25, 30, 200, 'bbbb1111-cccc-2222-dddd-333344445555', 'Office-Storage'),
('inv77777-7777-7777-7777-777777777777', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'SOFT-001', 'Microsoft Office 365 Business License', 'Annual business license for Office 365', 'services', 150.00, 10, 5, 50, 'bbbb2222-cccc-3333-dddd-444455556666', 'Digital-Licenses');
...
('po333333-3333-3333-3333-333333333333', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'bbbb1111-cccc-2222-dddd-333344445555', 'STARTUPHUB-000001', 'completed', 538.50, '2024-09-10', '2024-09-15', '66666666-6666-6666-6666-666666666666');
...
('cust4444-4444-4444-4444-444444444444', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'Lisa Wong', 'lisa.wong@localfirm.com', '+1-555-2001', 'Local Business Firm', 'smb', 'active', 15000.00, '2024-01-10'),
('cust5555-5555-5555-5555-555555555555', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'Robert Taylor', 'robert@creativeagency.com', '+1-555-2002', 'Creative Design Agency', 'smb', 'active', 22000.00, '2024-04-18');
...
-- StartupHub tickets
('tick4444-4444-4444-4444-444444444444', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'cust4444-4444-4444-4444-444444444444', '77777777-7777-7777-7777-777777777777', 'STARTUPHUB-000001', 'Billing Question', 'Customer has questions about recent invoice charges', 'medium', 'resolved', 'Billing'),
('tick5555-5555-5555-5555-555555555555', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'cust5555-5555-5555-5555-555555555555', '77777777-7777-7777-7777-777777777777', 'STARTUPHUB-000002', 'Dashboard Not Loading', 'Customer reports dashboard showing blank page', 'urgent', 'in_progress', 'Technical');
...
('conv3333-3333-3333-3333-333333333333', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', '55555555-5555-5555-5555-555555555555', 'Marketing Strategy Brainstorm', 'gpt-3.5-turbo', 6, 3800);
...
-- StartupHub datasets
('data3333-3333-3333-3333-333333333333', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'Website Analytics', 'Website traffic and conversion data', 'csv', 5200, true, '55555555-5555-5555-5555-555555555555');
...
('dash4444-4444-4444-4444-444444444444', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'Business Overview', 'Key business metrics for startup monitoring', '{"layout": "grid", "columns": 3, "rows": 3}', true, '55555555-5555-5555-5555-555555555555');
...
-- StartupHub widgets
('widg4444-4444-4444-4444-444444444444', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'dash4444-4444-4444-4444-444444444444', 'Monthly Growth', 'chart_line', '{"metric": "monthly_growth", "timeframe": "12m"}', '{"x": 0, "y": 0}', '{"width": 2, "height": 1}');

-- Notifications
INSERT INTO notification (org_id, user_id, type, title, message, created_at) VALUES
-- TechCorp notifications
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', '44444444-4444-4444-4444-444444444444', 'warning', 'High Priority Ticket', 'Ticket TECHCORP-000001 has been open for 2 days', now() - interval '2 hours'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', '22222222-2222-2222-2222-222222222222', 'info', 'Low Stock Alert', 'PC cases (CASE-001) are running low - only 15 units remaining', now() - interval '6 hours'),

-- StartupHub notifications
('b2c3d4e5-f6g7-8901-bcde-f21234567890', '77777777-7777-7777-7777-777777777777', 'urgent', 'Urgent Ticket', 'Customer dashboard loading issue requires immediate attention', now() - interval '30 minutes'),
('b2c3d4e5-f6g7-8901-bcde-f21234567890', NULL, 'system', 'System Maintenance', 'Scheduled maintenance window tomorrow 2-4 AM', now() - interval '1 day');

-- System metrics (sample data for last 7 days)
INSERT INTO system_metric (org_id, metric_name, metric_type, metric_value, unit, tags, timestamp) VALUES
-- TechCorp metrics
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'api_response_time', 'gauge', 145.5, 'ms', '{"endpoint": "/api/v1/customers"}', now() - interval '1 hour'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'api_response_time', 'gauge', 156.2, 'ms', '{"endpoint": "/api/v1/customers"}', now() - interval '2 hours'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'active_users', 'gauge', 1247, 'count', '{}', now() - interval '1 hour'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'ticket_resolution_time', 'gauge', 2.5, 'hours', '{"priority": "high"}', now() - interval '3 hours'),

-- StartupHub metrics
('b2c3d4e5-f6g7-8901-bcde-f21234567890', 'api_response_time', 'gauge', 98.3, 'ms', '{"endpoint": "/api/v1/dashboard"}', now() - interval '1 hour'),
('b2c3d4e5-f6g7-8901-bcde-f21234567890', 'active_users', 'gauge', 127, 'count', '{}', now() - interval '1 hour'),
('b2c3d4e5-f6g7-8901-bcde-f21234567890', 'customer_satisfaction', 'gauge', 4.2, 'rating', '{"scale": "1-5"}', now() - interval '1 day');
...
('conn3333-3333-3333-3333-333333333333', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'Google Workspace', 'google_workspace', '{"domain": "startuphub.com", "admin_email": "emma@startuphub.com"}', 'active', 120, '55555555-5555-5555-5555-555555555555');
...
-- StartupHub alerts
('alert333-3333-3333-3333-333333333333', 'b2c3d4e5-f6g7-8901-bcde-f21234567890', 'Customer Satisfaction Drop', 'Alert when customer satisfaction falls below 4.0', 'customer_satisfaction', '{"operator": "<", "threshold": 4.0}', 'warning', '55555555-5555-5555-5555-555555555555');
