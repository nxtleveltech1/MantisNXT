-- Migration: Seed New Streamlined Category Hierarchy
-- Description: Seeds new streamlined category hierarchy replacing 309 old categories
-- Generated: 2025-12-18T11:34:36.894Z
...
-- Level 1 Categories (15 categories)
...
-- Level 2 Categories (72 categories)
INSERT INTO core.category (name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (
  'Electric Guitars',
  get_category_id_by_path('/guitars-basses--amps')::uuid,
  2,
...
VALUES (
  'Acoustic Drums',
  get_category_id_by_path('/drums--percussion')::uuid,
  2,
...
VALUES (
  'Digital Pianos',
  get_category_id_by_path('/keyboards-pianos--synths')::uuid,
  2,
...
VALUES (
  ...
  get_category_id_by_path('/orchestral-band--folk')::uuid,
  2,
...
VALUES (
  'Studio Microphones',
  get_category_id_by_path('/microphones--wireless')::uuid,
  2,
...
VALUES (
  'DAWs & Editors',
  get_category_id_by_path('/software--plugins')::uuid,
  2,
...
-- Level 3 Categories (201 categories)
INSERT INTO core.category (name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (
  'Solid-Body (Standard/Extended Range)',
  get_category_id_by_path('/guitars-basses--amps/electric-guitars')::uuid,
  3,
...
VALUES (
  ...
  get_category_id_by_path('/guitars-basses--amps/acousticelectro-acoustic-guitars')::uuid,
  3,
...
VALUES (
  ...
  get_category_id_by_path('/guitars-basses--amps/basses')::uuid,
  3,
...
VALUES (
  'Starter Packs',
  get_category_id_by_path('/guitars-basses--amps/guitar--bass-packs')::uuid,
  3,
...
VALUES (
  ...
  get_category_id_by_path('/guitars-basses--amps/guitar-amplifiers')::uuid,
  3,
...
VALUES (
  'Combo',
  get_category_id_by_path('/guitars-basses--amps/bass-amplifiers')::uuid,
  3,
...
VALUES (
  'Drive & Distortion',
  get_category_id_by_path('/guitars-basses--amps/pedals--multi-fx')::uuid,
  3,
...
VALUES (
  'Shell Packs',
  get_category_id_by_path('/drums--percussion/acoustic-drums')::uuid,
  3,
...
VALUES (
  'Sets',
  get_category_id_by_path('/drums--percussion/cymbals')::uuid,
  3,
...
VALUES (
  'Full Kits',
  get_category_id_by_path('/drums--percussion/electronic-drums')::uuid,
  3,
...
VALUES (
  ...
  get_category_id_by_path('/drums--percussion/percussion')::uuid,
  3,
...
VALUES (
  'Stands & Pedals',
  get_category_id_by_path('/drums--percussion/drum-hardware--accessories')::uuid,
  3,
...
VALUES (
  'Console/Home',
  get_category_id_by_path('/keyboards-pianos--synths/digital-pianos')::uuid,
  3,
...
VALUES (
  'Performance Synths',
  get_category_id_by_path('/keyboards-pianos--synths/synthesizers--workstations')::uuid,
  3,
...
VALUES (
  'Stands & Benches',
  get_category_id_by_path('/keyboards-pianos--synths/keyboard-accessories')::uuid,
  3,
...
VALUES (
  ...
  get_category_id_by_path('/microphones--wireless/studio-microphones')::uuid,
  3,
...
VALUES (
  ...
  get_category_id_by_path('/microphones--wireless/live-microphones')::uuid,
  3,
...
VALUES (
  'Handheld Systems',
  get_category_id_by_path('/microphones--wireless/wireless-systems')::uuid,
  3,
...
-- Level 4 Categories (4 categories)
INSERT INTO core.category (name, parent_id, level, path, is_active, created_at, updated_at)
VALUES (
  'Amp & Pre-Amp Boards (Complete Replacements/Speaker-Specific)',
  get_category_id_by_path('/spares-components--consumables/electronic-spares/circuit-boards--assemblies')::uuid,
  4,
