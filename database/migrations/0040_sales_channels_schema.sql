...
CREATE INDEX idx_sales_channel_org ON core.sales_channel(org_id);
CREATE INDEX idx_sales_channel_type ON core.sales_channel(channel_type);
CREATE INDEX idx_sales_channel_active ON core.sales_channel(is_active) WHERE is_active = true;
CREATE INDEX idx_sales_channel_sync_status ON core.sales_channel(sync_status);
...
CREATE TABLE IF NOT EXISTS core.channel_product (
    ...
    CONSTRAINT uk_channel_external_id UNIQUE (channel_id, channel_product_id) WHERE channel_product_id IS NOT NULL
);

CREATE INDEX idx_channel_product_channel ON core.channel_product(channel_id);
CREATE INDEX idx_channel_product_product ON core.channel_product(product_id);
CREATE INDEX idx_channel_product_org ON core.channel_product(org_id);
CREATE INDEX idx_channel_product_active ON core.channel_product(channel_id, is_active) WHERE is_active = true;
CREATE INDEX idx_channel_product_sync_status ON core.channel_product(sync_status);
...
CREATE INDEX idx_channel_stock_channel ON core.channel_stock_allocation(channel_id);
CREATE INDEX idx_channel_stock_product ON core.channel_stock_allocation(product_id);
CREATE INDEX idx_channel_stock_location ON core.channel_stock_allocation(location_id);
CREATE INDEX idx_channel_stock_org ON core.channel_stock_allocation(org_id);
CREATE INDEX idx_channel_stock_type ON core.channel_stock_allocation(allocation_type);
...
CREATE TABLE IF NOT EXISTS core.channel_order (
    ...
    sales_order_id UUID, -- References sales_orders table (may be in public schema)
    customer_id UUID, -- References customer table (may be in public schema)
...
CREATE INDEX idx_channel_order_channel ON core.channel_order(channel_id);
CREATE INDEX idx_channel_order_sales_order ON core.channel_order(sales_order_id) WHERE sales_order_id IS NOT NULL;
CREATE INDEX idx_channel_order_customer ON core.channel_order(customer_id) WHERE customer_id IS NOT NULL;
CREATE INDEX idx_channel_order_org ON core.channel_order(org_id);
CREATE INDEX idx_channel_order_status ON core.channel_order(order_status, internal_status);
CREATE INDEX idx_channel_order_synced ON core.channel_order(synced_at);
CREATE INDEX idx_channel_order_external_id ON core.channel_order(external_order_id);
...
CREATE INDEX idx_channel_order_item_order ON core.channel_order_item(channel_order_id);
CREATE INDEX idx_channel_order_item_product ON core.channel_order_item(product_id) WHERE product_id IS NOT NULL;
CREATE INDEX idx_channel_order_item_sku ON core.channel_order_item(sku) WHERE sku IS NOT NULL;
...
CREATE INDEX idx_channel_sync_log_channel ON core.channel_sync_log(channel_id);
CREATE INDEX idx_channel_sync_log_type ON core.channel_sync_log(sync_type, started_at);
CREATE INDEX idx_channel_sync_log_status ON core.channel_sync_log(status);
CREATE INDEX idx_channel_sync_log_started ON core.channel_sync_log(started_at DESC);
