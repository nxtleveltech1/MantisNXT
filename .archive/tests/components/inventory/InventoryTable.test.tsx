...
describe('InventoryTable', () => {
  ...
  describe('Selection', () => {
    ...
    it('should show selected items correctly', () => {
      render(<InventoryTable {...defaultProps} selectedItems={['item-1', 'item-3']} />);
    ...
    it('should handle deselection', async () => {
      const user = userEvent.setup();
      render(<InventoryTable {...defaultProps} selectedItems={['item-1']} />);
  ...
  describe('Sorting', () => {
    ...
    it('should show sort indicators', () => {
      render(<InventoryTable {...defaultProps} sortConfig={{ field: 'name', direction: 'asc' }} />);
    ...
    it('should show descending sort indicator', () => {
      render(
        <InventoryTable {...defaultProps} sortConfig={{ field: 'name', direction: 'desc' }} />
      );
  ...
  describe('Error Handling', () => {
    it('should handle missing data gracefully', () => {
      ...
      render(<InventoryTable {...defaultProps} items={itemsWithMissingData as any} />);
    ...
    it('should handle action errors gracefully', async () => {
      ...
      render(<InventoryTable {...defaultProps} onItemEdit={onItemEditWithError} />);
