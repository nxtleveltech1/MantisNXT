...
describe('PricelistUploadWizard', () => {
  ...
  describe('File Upload', () => {
    ...
    it('should reject invalid file types', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Invalid file type. Please upload an Excel file.')).toBeInTheDocument()
      })
    })
      ...
      const mockReader = {
        read: jest.fn()
          ...
          .mockResolvedValueOnce({
            ...
            value: new TextEncoder().encode('data: {"progress": 100, "processed": 100, "complete": true}\n\n')
          })
          .mockResolvedValueOnce({
            done: true,
            value: undefined
