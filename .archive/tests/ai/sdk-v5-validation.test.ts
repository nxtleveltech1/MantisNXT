...
describe('Vercel AI SDK v5 Integration Tests', () => {
  ...
  describe('2. Chat Endpoint (/api/ai/chat)', () => {
    ...
    it(
      ...
      async () => {
        ...
        const { response, data } = await apiCall(`/api/ai/chat?conversationId=${conversationId}`);
  ...
  describe('3. Generate Endpoint (/api/ai/generate)', () => {
    ...
    it(
      'should generate content with specific parameters',
      async () => {
        const { response, data } = await apiCall('/api/ai/generate', {
          method: 'POST',
          body: JSON.stringify({
    ...
    it(
      'should support batch generation',
      async () => {
        const { response, data } = await apiCall('/api/ai/generate', {
          method: 'POST',
          body: JSON.stringify({
  ...
  describe('5. Supplier Discovery (/api/ai/suppliers/discover)', () => {
    it(
      'should discover suppliers based on criteria',
      async () => {
  ...
  describe('8. Insights Generation (/api/ai/insights/generate)', () => {
    it(
      'should generate business insights',
      async () => {
  ...
  describe('9. Error Handling', () => {
    ...
    it(
      'should timeout on extremely long requests',
      async () => {
  ...
  describe('10. Performance Metrics', () => {
    it(
      'should complete chat request within acceptable time',
      async () => {
