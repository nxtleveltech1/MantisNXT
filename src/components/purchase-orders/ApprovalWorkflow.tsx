        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="text-center">
              ...
              <div className="text-muted-foreground text-sm">Current Step</div>
            </div>
            <div className="text-center">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              {approvalStatus.status === 'rejected' && <XCircle className="h-5 w-5 text-red-500" />}
              {approvalStatus.status === 'pending' && <Clock className="h-5 w-5 text-yellow-500" />}
            ...
            <Card key={step.id} className={cn('transition-colors', getStepColor(step.status))}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        <span className="text-muted-foreground text-sm">{step.approverName}</span>
                        {step.required && (
                        ...
                        <span>
                          {step.status === 'approved'
                            ...
                            : step.status === 'rejected'
                              ? 'Rejected'
                              : 'Processed'}{' '}
                          on {formatDate(step.approvedDate)}
                        </span>
                      </div>
                    )}
              ...
              {step.status === 'pending' && (
                <CardContent className="pt-0">
                  <div className="space-y-3">
                    <div>
                      <label htmlFor={commentFieldId} className="text-muted-foreground text-sm">
        ...
        <CardContent>
          <div className="space-y-4">
            {workflow
              ...
              .sort(
                (a, b) => new Date(a.approvedDate!).getTime() - new Date(b.approvedDate!).getTime()
              )
              .map((step, index) => (
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">{step.approverRole}</p>
                      </div>
