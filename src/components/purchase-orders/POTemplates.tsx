                  ...
                  <CardContent>
                    ...
                    {template.supplier && (
                      <div className="mb-4">
                        ...
                        <p className="text-muted-foreground text-sm">{template.supplier.name}</p>
                      </div>
                    )}
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <Input id="template-name" placeholder="e.g., Standard Laptop Setup" />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <Input id="default-supplier" placeholder="Search suppliers..." />
                  </div>
                ...
                <div>
                  <h4 className="mb-4 font-medium">Template Items</h4>
                ...
                <div>
                  <h4 className="mb-4 font-medium">Default Terms</h4>
          ...
          <TabsContent value="favorites" className="space-y-6">
            ...
            {mockTemplates.filter(t => t.isFavorite).length === 0 && (
              <div className="py-12 text-center">
                ...
                <h3 className="mb-2 text-lg font-semibold">No Favorite Templates</h3>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="rounded-lg border">
                    <div className="bg-muted grid grid-cols-12 gap-4 p-3 text-sm font-medium">
