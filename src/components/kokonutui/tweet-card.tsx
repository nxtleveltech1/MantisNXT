        ...
        >
          ...
          <div className="mt-2">
            {content.map((item, index) => (
              <p key={index} className="text-base text-black dark:text-white/90">
                {item}
              </p>
            ))}
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm text-black dark:text-white/60">·</span>
                    <span className="text-sm text-black dark:text-white/60">{reply.timestamp}</span>
                  </div>
                  <p className="mt-1 text-sm text-black dark:text-white/80">{reply.content}</p>
                </div>
              </div>
            </div>
          )}
