      ...
      <div className="relative z-10">
        ...
        <div className="mt-4">
          <div className="space-y-1">
            <h2 className="text-left text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
              {product.title}
            </h2>
            <span className="block bg-gradient-to-r from-gray-400 via-gray-300 to-gray-500 bg-clip-text text-left text-3xl font-semibold tracking-tight text-transparent dark:from-gray-200 dark:via-white dark:to-gray-300">
              {product.subtitle}
            </span>
          </div>
