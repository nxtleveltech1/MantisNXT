      ...
      >
        <AnimatePresence>
          {activeNotification && (
            ...
            >
              <div className="bg-primary text-primary-foreground rounded-full px-3 py-1 text-xs">
              ...
              <motion.div
                ...
                animate="animate"
                exit="exit"
                className="bg-primary absolute -bottom-1 left-1/2 h-[2px] w-full origin-left"
              />
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <div className="flex items-center gap-2">
          ...
          <motion.button
            ...
            className={cn(
              ...
              'active:border-primary/50 hover:shadow-md',
              isToggled
                ? [
