...
export function ProductEnrichmentPanel({ products, onEnrichmentComplete }: ProductEnrichmentPanelProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Use AI to enrich product information: correct names, generate descriptions, and suggest tags
        </CardDescription>
      </CardHeader>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground">SKU: {product.supplier_sku}</div>
                    {result && (
                      <div className="mt-2 space-y-1 text-sm">
                        {result.product_name && result.product_name !== product.name_from_supplier && (
                          <div>
                        ...
                        {result.short_description && (
                          <div>
                            <span className="font-medium">Short Description:</span> {result.short_description}
                          </div>
                        )}
