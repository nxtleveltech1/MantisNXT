      ...
      <div className="p-6 text-white">
        <div className="space-y-4 mb-6">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-sm">Complete product catalog</span>
          </div>
          <div className="flex items-center space-x-3">
            <MessageCircle className="h-5 w-5 text-green-200" />
            <span className="text-sm">Orders directly via WhatsApp</span>
          </div>
          <div className="flex items-center space-x-3">
            <Smartphone className="h-5 w-5 text-green-200" />
            <span className="text-sm">Easy and fast access</span>
          </div>
        </div>

        {/* Featured Products Preview */}
        <div className="bg-white/10 rounded-lg p-4 mb-6">
          <h3 className="font-semibold mb-3 text-center">Available Products:</h3>
        ...
        <div className="mt-4 p-3 bg-white/10 rounded-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-green-100">Direct link:</span>
            </div>
          </div>
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-green-100">📱 Place your order and receive via WhatsApp</p>
          <p className="text-xs text-green-200 font-semibold">Fast delivery • Original products</p>
        </div>
      </div>
    </div>
  )
