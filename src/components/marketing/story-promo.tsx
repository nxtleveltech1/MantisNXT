      ...
      <div className="h-full">
        ...
        >
          <div className="text-center space-y-4">
            <h2 className="text-4xl font-bold text-white">Tech Accessories</h2>
            <p className="text-xl text-green-100">The best products for your device</p>
            ...
            <p className="text-white text-lg font-medium">Swipe to see more</p>
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-6">Available Products</h2>
        ...
        >
          <div className="text-center space-y-6">
            <h2 className="text-3xl font-bold text-white">Place your order now!</h2>

            <div className="bg-white p-4 rounded-xl">
              <div className="bg-green-100 p-3 rounded-lg mb-4">
                <QrCode className="h-48 w-48 mx-auto text-green-700" />
              </div>
              <p className="text-green-700 font-medium">Scan to access</p>
            </div>

            <div className="flex items-center justify-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full py-3 px-6">
              <MessageCircle className="h-5 w-5 text-white" />
              <span className="text-white font-medium">Orders via WhatsApp</span>
            </div>
