...
import { Download, Settings2, RefreshCw, Package, CheckCircle2, Clock, TrendingUp, Tags } from "lucide-react"
...
const DEFAULT_COLUMNS: ColumnDef[] = [
  ...
  { key: 'confidence', label: 'Confidence', visible: true, order: 6, align: 'left', sortable: true },
...
export const TagProductsTable = memo(function TagProductsTable({ refreshTrigger }: ProductsTableProps) {
  ...
  }, [limit, page, search, supplierId, statusFilter, confidenceMin, confidenceMax, sortBy, sortDir])
      ...
      <CardContent>
        ...
        <div className="flex flex-col gap-4 mb-4 md:flex-row md:items-end">
          <div className="flex-1">
            <LabelInput label="Search Products" value={search} onChange={setSearch} placeholder="Search by SKU or name..." />
          </div>
          <div className="flex-1">
