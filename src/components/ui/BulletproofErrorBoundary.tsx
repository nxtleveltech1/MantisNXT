                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {error.stack && (
                      <details className="group">
                        <summary className="cursor-pointer text-red-800 hover:text-red-600 dark:text-red-200 dark:hover:text-red-400">
                          <strong>Stack Trace</strong>
                        </summary>
                        <pre className="mt-2 max-h-40 overflow-auto font-mono text-xs whitespace-pre-wrap text-red-700 dark:text-red-300">
                          {error.stack}
                        </pre>
                      </details>
                    )}
