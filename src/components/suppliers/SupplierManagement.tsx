                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setFilters({
                          performance_tier:
                            value && value !== 'all_tiers' ? [value as unknown] : undefined,
                        })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setFilters({
                          category: value && value !== 'all_categories' ? [value] : undefined,
                        })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setFilters({
                          region: value && value !== 'all_regions' ? [value] : undefined,
                        })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setFilters({
                          bee_level: value && value !== 'all_levels' ? [value] : undefined,
                        })
                      }
                    >
                      <SelectTrigger>
                      ...
                      <TableRow key={supplier.id}>
                        ...
                        <TableCell>
                          <div className="text-muted-foreground font-mono text-xs">
                            {supplier.orgId ||
                              (supplier as unknown as { org_id?: string }).org_id ||
                              '—'}
                          </div>
                        </TableCell>
                        <TableCell>
