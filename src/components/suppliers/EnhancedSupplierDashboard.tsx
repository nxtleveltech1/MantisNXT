...
const AISupplierDiscovery = dynamic(() => import('@/components/suppliers/AISupplierDiscovery'), {
...
const EnhancedSupplierDashboard = ({ onSupplierSelect }: EnhancedSupplierDashboardProps) => {
  const {
  ...
  const handlePricelistUpload = useCallback(
    async (supplierId: string, result: DataValidationResult) => {
  ...
  const dashboardMetrics = useMemo(() => {
    ...
    const totalSpend = suppliers.reduce(
      (sum, s) => sum + s.performanceMetrics.financialMetrics.totalSpend,
      0
    );
    const avgRating =
    ...
    const avgOnTimeDelivery =
      suppliers.length > 0
        ? suppliers.reduce(
            (sum, s) => sum + s.performanceMetrics.deliveryPerformance.onTimeDeliveryRate,
            0
          ) / suppliers.length
        : 0;
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground text-xs">{supplier.industry}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                        ...
                        <TableCell>
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-muted-foreground text-sm">{supplier.code}</div>
                            </div>
                          </div>
                        </TableCell>
                        <TableCell>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Progress
                          value={
                            (supplier.performanceMetrics.qualityMetrics.qualityRating / 5) * 100
                          }
                          className="h-2"
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span>
                            {supplier.performanceMetrics.relationshipMetrics.responsiveness}/10
                          </span>
                        </div>
                        <Progress
                          value={
                    ...
                    {suppliers.map(supplier => (
                      <div key={supplier.id} className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span>
                            {formatCurrency(
                              supplier.performanceMetrics.financialMetrics.totalSpend
                            )}
                          </span>
                        </div>
                        <Progress
          ...
          <Dialog open={!!selectedSupplier} onOpenChange={() => setSelectedSupplier(null)}>
            <DialogContent className="max-h-[90vh] max-w-4xl overflow-y-auto">
              ...
              <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          {selectedSupplier.primaryContact.name} (
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  ...
                  <Card>
                    <CardContent className="p-4 text-center">
                      ...
                      <div className="text-muted-foreground text-sm">Quality Rating</div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-purple-600">
                        {formatCurrency(
                          selectedSupplier.performanceMetrics.financialMetrics.totalSpend
                        )}
                      </div>
                ...
                {/* Recent Pricelists */}
                <div>
                  <h4 className="mb-3 font-medium">Recent Pricelists</h4>
                  <div className="space-y-2">
