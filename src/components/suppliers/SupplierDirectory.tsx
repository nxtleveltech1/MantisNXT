...
const sampleSuppliers: Supplier[] = [
  {
    ...
    capabilities: {
      ...
      certifications: [
        { id: 'cert1', name: 'ISO 9001:2015', issuer: 'SABS', validUntil: '2025-12-31' },
      ],
      leadTime: 14,
  ...
  },
  {
    ...
    capabilities: {
      ...
      certifications: [
        { id: 'cert2', name: 'BEE Level 2', issuer: 'SANAS', validUntil: '2025-06-30' },
      ],
      leadTime: 21,
  ...
  },
  {
    ...
    capabilities: {
      ...
      certifications: [
        { id: 'cert3', name: 'BEE Level 3', issuer: 'SANAS', validUntil: '2025-03-31' },
      ],
      leadTime: 28,
...
const SupplierDirectory: React.FC<SupplierDirectoryProps> = () => {
  ...
  const filterOptions = useMemo(() => {
    ...
    const locations = Array.from(
      new Set(suppliers.map(s => s.addresses[0]?.country).filter(Boolean))
    );
  ...
  const handleSelectAll = useCallback(() => {
    setSelectedSuppliers(prev =>
      prev.length === paginatedSuppliers.length ? [] : paginatedSuppliers.map(s => s.id)
    );
  }, [paginatedSuppliers]);
  ...
  const breadcrumbs = [{ label: 'Suppliers' }];
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-muted-foreground text-sm">Strategic</p>
                <p className="text-2xl font-bold">
          ...
          {showFilters && (
            <div className="bg-muted/50 mt-4 rounded-lg border p-4">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-5">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setFilters(prev => ({
                        ...prev,
                        status: value ? [value as unknown] : undefined,
                      }))
                    }
                  >
                    <SelectTrigger>
                ...
                <div>
                  <p className="mb-2 block text-sm font-medium">Tier</p>
                  <Select
                    value={filters.tier?.[0] || ''}
                    onValueChange={value =>
                      setFilters(prev => ({
                        ...prev,
                        tier: value ? [value as unknown] : undefined,
                      }))
                    }
                  >
                    <SelectTrigger>
                ...
                <div>
                  <p className="mb-2 block text-sm font-medium">Location</p>
                  <Select
                ...
                <div>
                  <p className="mb-2 block text-sm font-medium">View</p>
                ...
                <TableRow key={supplier.id}>
                  ...
                  <TableCell>
                    <div>
                      ...
                      {supplier.subcategory && (
                        <div className="text-muted-foreground text-sm">{supplier.subcategory}</div>
                      )}
                    </div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="text-sm">
                      {supplier.lastContactDate ? formatDate(supplier.lastContactDate) : 'Never'}
                    </div>
                  </TableCell>
