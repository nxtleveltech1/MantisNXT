...
export default function SocialMediaDashboard() {
  ...
  const channels = [
    { id: 1, platform: 'Facebook', handle: '@NXTLevelTechSA', followers: '45.2K' },
    { id: 2, platform: 'Instagram', handle: '@nxtleveltech_sa', followers: '32.8K' },
    { id: 3, platform: 'TikTok', handle: '@nxtleveltech', followers: '28.4K' },
    { id: 4, platform: 'WhatsApp', handle: 'Business Chat', followers: '2.1K' },
  ];
    ...
    <SidebarProvider defaultOpen>
      ...
      <SidebarInset>
        ...
        <div className="space-y-8">
          {/* Header */}
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-2">NXT Level TECH - South Africa</h2>
            <p className="text-lg text-gray-600">Sales, Rentals, Repairs & Recording Studio | Saxenburg Park 2, Cape Town.</p>
          </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-6">
                {channels.map((platform) => {
                  ...
                  return (
                    <div key={platform.id} className="flex items-center justify-between p-4 rounded-lg hover:bg-gray-50 transition-colors">
