...
export default function PriceHistoryPage() {
  ...
  const chartData = React.useMemo(() => {
    ...
    return sortedDates.map((date) => {
      const internal = history.internalPriceHistory.find(
        (h) => h.date.split('T')[0] === date
      )
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Historical price comparison with competitors
                    </CardDescription>
                  </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Since period start</p>
                </CardContent>
              </Card>
