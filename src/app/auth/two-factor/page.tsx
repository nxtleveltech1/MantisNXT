        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-green-800">2FA Setup Complete!</CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              <div className="bg-green-50 p-4 rounded-lg">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-semibold text-green-800">Your account is now more secure!</span>
                </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  After adding MantisNXT to your authenticator app, enter the 6-digit code it generates
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {error && (
