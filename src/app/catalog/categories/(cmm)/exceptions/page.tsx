...
export default function ExceptionsPage() {
  ...
  const isCoreMode = useMemo(() => unmatchedItems.some((item) => item.status || item.aiConfidence !== undefined), [unmatchedItems])
  ...
  return (
    <AppLayout
      ...
      breadcrumbs={[{ label: "Category Management", href: "/catalog/categories" }, { label: "Exceptions" }]}
    >
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Require manual action</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Value tied to unmatched SKUs</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Unique suppliers with exceptions</p>
            </CardContent>
          </Card>
        </div>
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              setUnmatchedItems((prev) => prev.filter((candidate) => candidate.id !== item.id))
                            }
                          >
