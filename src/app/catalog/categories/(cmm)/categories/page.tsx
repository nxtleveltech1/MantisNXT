      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Review category coverage, depth, and outstanding reviews.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
              <div className="space-y-2">
                {[1, 2, 3].map(key => (
                  <div key={key} className="bg-muted h-12 animate-pulse rounded-md" />
                ))}
              </div>
            ) : categories.length === 0 ? (
                ...
                {categories.map(category => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <GitBranch className="text-muted-foreground mt-1 h-4 w-4" />
                        <div>
                          <div className="font-medium">{category.name}</div>
                          <div className="text-muted-foreground text-xs">{category.path}</div>
                        </div>
                      </div>
