              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm">
                    ...
                    Services → Product Categories to manage providers, API keys, and model settings.
                  </p>
                ...
                <div className="space-y-2 border-t pt-4">
                  ...
                  <ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
                    <li>
                      Products without categories are always categorized (if confidence ≥ threshold)
                    </li>
                    <li>
                      Products with AI confidence scores are only re-categorized if new confidence
                      is higher
                    </li>
                    <li>
                      Products with categories but no confidence are re-categorized if new
