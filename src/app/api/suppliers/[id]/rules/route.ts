...
export async function POST(
  ...
  try {
    ...
    const { rule_name, rule_type, trigger_event, execution_order, rule_config, error_message_template, is_blocking } = body
...
export async function PUT(
  ...
  try {
    ...
    const { rule_id, rule_name, rule_type, trigger_event, execution_order, rule_config, error_message_template, is_blocking } = body
