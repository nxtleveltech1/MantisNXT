  ...
  try {
    ...
    if (schemaMode === "none") {
      ...
      return NextResponse.json([
        ...
        { id: "cat-002", name: "Electric Guitars", parentId: "cat-001", path: "Instruments>Electric Guitars" },
        { id: "cat-003", name: "Acoustic Guitars", parentId: "cat-001", path: "Instruments>Acoustic Guitars" },
