  ...
  try {
    ...
    const mockMetrics = {
      ...
      recentActivity: [
        {
          type: 'order',
          description: 'New order from Acme Suppliers',
          timestamp: '2025-10-24T10:30:00Z',
        },
        {
          type: 'supplier',
          description: 'New supplier Tech Solutions Ltd added',
          timestamp: '2025-10-24T09:15:00Z',
        },
        {
          type: 'pricelist',
          description: 'Pricelist updated for Office Supplies SA',
          timestamp: '2025-10-24T08:45:00Z',
        },
      ],
      alerts: [
