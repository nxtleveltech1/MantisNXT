        ...
        {alerts.length > 0 && (
          <div className="space-y-2">
            {alerts.map((alert, index) => (
              ...
              >
                <AlertTriangle
                  className={`h-4 w-4 ${alert.type === 'error' ? 'text-red-600' : 'text-yellow-600'}`}
                />
                <AlertDescription>
                  <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-5">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground text-xs">Overall system health</p>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground text-xs">
                  {formatBytes(systemData.system.memory.used)} /{' '}
                  {formatBytes(systemData.system.memory.total)}
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {systemData.databases.filter(db => db.status === 'connected').length}/
                  {systemData.databases.length}
                </div>
                <p className="text-muted-foreground text-xs">Databases online</p>
              </CardContent>
            </Card>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-muted-foreground text-xs">Req/sec</div>
                        </div>
                        <div className="text-center">
                          <div
                            className={`text-sm font-medium ${service.errors > 0 ? 'text-red-600' : 'text-green-600'}`}
                          >
                            {service.errors}
                          </div>
                  ...
                  {systemData?.databases.map((db, index) => (
                    <div key={index} className="rounded-lg border p-4">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                        <div>
                          <div className="mb-1 text-sm font-medium">Response Time</div>
                          <div className="text-lg font-bold">{db.responseTime}ms</div>
                        </div>

                        <div>
                          <div className="mb-1 text-sm font-medium">Connections</div>
                        ...
                        <div>
                          <div className="mb-1 text-sm font-medium">Query Performance</div>
                          <div className="text-sm">Avg: {db.queryPerformance.avgQueryTime}ms</div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="rounded-lg bg-blue-50 p-4 text-center">
                        ...
                        <div className="text-muted-foreground text-xs">MB/s In</div>
                      </div>
                      <div className="rounded-lg bg-green-50 p-4 text-center">
                        <Download className="mx-auto mb-2 h-6 w-6 text-green-600" />
                        <div className="text-xl font-bold text-green-600">
                          {systemData?.system.network.outbound || 0}
                        </div>
                        <div className="text-muted-foreground text-xs">MB/s Out</div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="text-muted-foreground text-sm">
                    Expires:{' '}
                    {systemData?.security.ssl.expiryDate
                      ? new Date(systemData.security.ssl.expiryDate).toLocaleDateString()
                      : 'N/A'}
                  </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="rounded-lg bg-blue-50 p-4 text-center">
                      ...
                      <div className="text-muted-foreground text-sm">Valid Certificate</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-sm">
                      {systemData?.overall.lastUpdated
                        ? new Date(systemData.overall.lastUpdated).toLocaleString()
                        : 'N/A'}
                    </div>
                  </div>
                </div>
