              ...
              <CardContent className="space-y-6">
                  ...
                  <>
                    <div className="space-y-4">
                      <Alert>
                        ...
                        <AlertDescription>
                          <p className="mb-2 font-semibold">Before importing:</p>
                          <ul className="list-inside list-disc space-y-1 text-sm">
                            <li>Download the CSV template below</li>
                            <li>
                              Fill in all required fields (name, email, role, department, phone)
                            </li>
                            <li>Ensure email addresses are unique and valid</li>
                            <li>
                              Use valid role values: {USER_ROLES.map(r => r.value).join(', ')}
                            </li>
                          </ul>
                        </AlertDescription>
                      </Alert>
                ...
                {operation.status === 'processing' && (
                  <div className="space-y-4 py-8 text-center">
                    ...
                    <div>
                      <p className="mb-2 font-medium">Processing CSV...</p>
                      <Progress value={operation.progress} className="mx-auto w-64" />
                          ...
                          <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-2xl font-bold">{operation.result.total}</p>
                              </div>
                          ...
                          <CardContent>
                            <div className="max-h-96 space-y-3 overflow-y-auto">
                              {operation.result.errors.map((error, index) => (
                                <div
                                  key={index}
                                  className="flex items-start space-x-3 rounded-lg border border-red-200 bg-red-50 p-3"
                                >
          ...
          <TabsContent value="role-assignment">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Assign roles to multiple selected users at once</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <Alert>
                ...
                <div className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      ...
                      and click &quot;Activate&quot; or &quot;Deactivate&quot; from the bulk actions
                      menu.
                    </AlertDescription>
                  </Alert>
