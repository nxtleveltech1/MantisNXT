...
import { scheduleSyncArInvoiceToXero } from '@/lib/xero/sync/sales-ar-bridge';
...
export class ARService {
  ...
  static async createCustomerInvoice(data: {
    ...
    try {
      ...
      // Sync to Xero in background - don't block invoice creation
      void scheduleSyncArInvoiceToXero(data.org_id, invoice.id);
