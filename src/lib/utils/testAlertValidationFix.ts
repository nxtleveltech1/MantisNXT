...
import { validateAlertItems, debugAlertStructure, transformAlertItem, isValidAlertItem } from './dataValidation';
...
function runTests() {
  ...
  console.log(`  Success rate: ${((validatedAlerts.length / testAlerts.length) * 100).toFixed(1)}%`);
