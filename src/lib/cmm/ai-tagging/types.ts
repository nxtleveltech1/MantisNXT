/**
 * AI Tagging System Types
 * Comprehensive type definitions for job management and tagging tracking
 * Mirrors: src/lib/cmm/ai-categorization/types.ts
 */
...
export type JobType = 'full_scan' | 'partial' | 'retag' | 'import_triggered';
...
export interface TaggingResult {
  ...
  provider: string | null;
  reasoning: string | null;
  skipped_reason?: 'already_tagged' | 'low_confidence' | 'no_suggestion' | 'error';
  proposed_tag_ids?: string[] | null;
  proposed_tag_names?: string[] | null;
}
...
export interface EnrichedProductWithStatus extends EnrichedProduct {
  ...
  proposed_tag_ids?: string[] | null;
  proposed_tag_names?: string[] | null;
  proposed_tag_status?: string | null;
}
...
export interface ProductsQueryParams {
  ...
  limit?: number;
  offset?: number;
  sort_by?: 'name' | 'confidence' | 'tagged_at' | 'supplier';
  sort_order?: 'asc' | 'desc';
}
...
// Type aliases for API routes (for clarity and consistency)
export type StartTaggingJobRequest = StartJobRequest;
export type StartTaggingJobResponse = StartJobResponse;
export type TaggingJobStatusResponse = JobStatusResponse;
export type TaggingProductsQueryParams = ProductsQueryParams;
export type TaggingProductsQueryResponse = ProductsQueryResponse;
export type CancelTaggingJobResponse = CancelJobResponse;
export type EnrichedProductWithTaggingStatus = EnrichedProductWithStatus;
...
export interface TaggingStats {
  ...
  by_status: Record<TaggingStatus, number>;
