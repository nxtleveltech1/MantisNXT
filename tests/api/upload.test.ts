...
describe('/api/upload', () => {
  ...
  beforeEach(() => {
    ...
    process.env.UPLOAD_ALLOWED_TYPES = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/csv,image/jpeg'
  ...
  describe('POST /api/upload', () => {
    it('should upload a valid XLSX file successfully', async () => {
      ...
      expect(data.fileType).toBe('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
  ...
  describe('GET /api/upload', () => {
    it('should return upload configuration', async () => {
      ...
      expect(data).toEqual({
        ...
        allowedTypes: ['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'text/csv', 'image/jpeg'],
        uploadEnabled: true,
