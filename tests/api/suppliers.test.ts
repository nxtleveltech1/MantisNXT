...
import { GET as GetSingle, PUT as PutSingle, DELETE as DeleteSingle } from '@/app/api/suppliers/[id]/route'
...
describe('/api/suppliers', () => {
  ...
  describe('GET /api/suppliers', () => {
    ...
    it('should sort suppliers by different fields', async () => {
      const request = new NextRequest('http://localhost:3000/api/suppliers?sortBy=name&sortOrder=asc')
      const response = await GET(request)
      const data = await response.json()
  ...
  describe('GET /api/suppliers/pricelists', () => {
    ...
    it('should filter pricelists by supplier', async () => {
      const request = new NextRequest('http://localhost:3000/api/suppliers/pricelists?supplierId=test-sup-1')
      const response = await GetPricelists(request)
      const data = await response.json()
