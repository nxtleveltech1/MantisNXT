...
describe('Supplier Rules Engine', () => {
  ...
  describe('applyVatPolicyConfig', () => {
    it('should apply VAT policy to rows', () => {
      const rows = [
        { supplier_sku: 'SKU001', name: 'Product 1', cost_price_ex_vat: 100.0 },
        { supplier_sku: 'SKU002', name: 'Product 2', price_incl_vat: 230.0 },
      ...
      expect(result.rows[1].cost_price_ex_vat).toBe(200.0); // Derived
